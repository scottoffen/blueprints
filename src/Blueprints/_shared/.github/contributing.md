...
We absolutely want to hear from you! **Your involvement makes Blueprint better** by improving usability, quality, and adoption. Our goal is to be responsive and transparent stewards of the project. Following these guidelines will help us help you.
...
* [Official documentation](https://$(GitHubOrg).github.io/$(GitHubRepo))
* [GitHub community discussions](https://github.com/$(GitHubOrg)/$(GitHubRepo)/discussions)
* [StackOverflow (tagged #blueprint)](https://stackoverflow.com/questions/tagged/blueprint?sort=newest)
...
* Provide details: OS + version, .NET version, Blueprint version.
...
Got an idea? Start by opening a [discussion](https://github.com/$(GitHubOrg)/$(GitHubRepo)/discussions) to gather feedback.
**Do not open a GitHub issue until there's positive consensus.**

When proposing features, we want to ensure we are **focused on solving problems, not attacking symptoms**, while staying true to Blueprint's guiding principles: **fast, unopinionated, minimalist**. In a word: **simple.**
...
Some reports are too vague, undefined, or out of scope. In those cases, we'll ask you to clarify what "done" looks like. If the goal remains undefined or unachievable (e.g., outside Blueprint's vision), the issue will be closed.
...
Blueprint is written in C#. The repository includes a comprehensive [`.editorconfig`](../.editorconfig) file that defines code style, formatting, and naming conventions across the project, as well as consistent rules for indentation, naming, style preferences, and analyzer severities.
...
Good documentation is critical to Blueprint's success. Docs are written in [Docusaurus](https://docusaurus.io/) and live in the [docs folder](./docs/). Contributions of clear, concise, and accurate documentation are highly valued.