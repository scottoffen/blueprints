...
- [ ] Follows the [contribution guidelines](https://github.com/$(GitHubOrg)/$(GitHubRepo))$/blob/main/.github/contributing.md) and C# conventions, with readability as a priority
